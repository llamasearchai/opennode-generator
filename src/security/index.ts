...
${comp.requirements
  .map(
    (req) => `
- **${req.id}**: ${req.description} - ${req.met ? '✅' : '❌'}
...
- **HTTPS Enforced**: ${scanResult.hardeningResults?.checks.httpsEnforced ? '✅' : '❌'}
- **Security Headers**: ${scanResult.hardeningResults?.checks.securityHeaders ? '✅' : '❌'}
- **Input Validation**: ${scanResult.hardeningResults?.checks.inputValidation ? '✅' : '❌'}
- **Error Handling**: ${scanResult.hardeningResults?.checks.errorHandling ? '✅' : '❌'}
- **Security Logging**: ${scanResult.hardeningResults?.checks.logging ? '✅' : '❌'}
